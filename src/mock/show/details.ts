...
import { mockPopularDetails } from '../popular';
import mockRecommendationsDetails from './recommendationsDetails';
...
const mockShowDetails: ShowDetails = {
  ...
  last_episode_to_air: {
    ...
    production_code: 'T27.14066',
    season_number: 7,
    still_path: '/zUZTFrSu7OSq53FVBm99wolZFSa.jpg',
    vote_average: 7.6,
    vote_count: 5,
  },
  name: 'The 100',
  ...
  seasons: [
    ...
    },
    {
      ...
      poster_path: '/9OfbNi3mzyn0rd0vnCP8gj4szW0.jpg',
      season_number: 7,
    },
  ],
  spoken_languages: [{ english_name: 'English', iso_639_1: 'en', name: 'English' }],
  status: 'Ended',
  tagline: "Survival isn't who you are. It's who you become.",
  type: 'Scripted',
  vote_average: 7.9,
  vote_count: 6571,
};

export default mockShowDetails;

export const mockShowsDetails = [
  mockShowDetails,
  ...mockPopularDetails,
  ...mockRecommendationsDetails,
];
